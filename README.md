...
[![Latest release](https://img.shields.io/github/v/release/liberusoftware/module-billing-customer-portal-api?sort=semver)](https://github.com/liberusoftware/module-billing-customer-portal-api/releases/latest) [![Tests](https://github.com/liberusoftware/module-billing-customer-portal-api/actions/workflows/tests.yml/badge.svg?branch=main)](https://github.com/liberusoftware/module-billing-customer-portal-api/actions/workflows/tests.yml)
...
```bash
composer require liberusoftware/module-billing-customer-portal-api
```
...
<a href="https://github.com/liberusoftware/module-billing-customer-portal-api/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=liberusoftware/module-billing-customer-portal-api" alt="Contributors to liberusoftware/module-billing-customer-portal-api">
</a>

[View the full contributors graph](https://github.com/liberusoftware/module-billing-customer-portal-api/graphs/contributors).
